namespace DentedPixel.LTEditor
{
	...
	public class LTEditor : object{
		...
		public Color colorAddOn = new Color(150f/255f,180f/255f,255f/255f);
	...
	public class LeanTweenVisualEditor : Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			GUI.DrawTexture( new Rect(16, iconRect.y - 16, icon.width, icon.height) , icon );
					...
					foreach(LeanTweenItem item in group.itemList)
					{
						...
						if(item.foldout)
						{
							...
							if(item.doesLoop){
								...
								EditorGUILayout.IntField(new GUIContent("",""),-1, GUILayout.Width(50));
